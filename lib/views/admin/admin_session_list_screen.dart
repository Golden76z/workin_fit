...
/// [adminSessionsProvider]. Creation reuses the full workout builder in preset
/// mode; editing an existing session is not yet supported (the builder can't
/// yet reverse-populate from a saved session), so rows are create/delete only.
